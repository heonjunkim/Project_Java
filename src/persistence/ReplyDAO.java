...
public class ReplyDAO {
	...
	MongoCollection<Document> collection = db.getCollection("movie02");
	
	public void addReply(ReplyDTO rDto) {
		Document doc = new Document("movieNm", rDto.getMovieNm()).append("content", rDto.getContent()).append("writer", rDto.getWriter())
